  ...
  return (
    <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
      ...
      <p className="text-sm max-w-xl mb-6 font-bold">
        ...
        gained expertise in both front-end and back-end technologies and
        ...
        create dynamic applications. Recently, I have ventured into the exciting
        realm of mobile development using React Native, where I am rapidly
        acquiring new skills. As I continue to expand my knowledge and gain
        hands-on experience, my goal is to become a versatile software engineer
